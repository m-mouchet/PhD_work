...
def PlotPairGeometry2(pair_e):
    plt.figure()
    plt.subplot(121)
    # plt.plot(250*np.cos(np.linspace(0,2*np.pi)), 250*np.sin(np.linspace(0,2*np.pi)), 'k--', linewidth=0.5)
    #epipolar drawings
    plt.plot([pair_e.s0[2], pair_e.s1[2]], [pair_e.s0[0], pair_e.s1[0]], 'k:')
    plt.plot(pair_e.s0[2], pair_e.s0[0], '.', color='indigo')
    plt.plot(pair_e.Det0[:, 0, 2], pair_e.Det0[:, 0, 0],color='indigo')
    plt.plot([pair_e.s0[2], pair_e.s0[2]-pair_e.sdd*np.cos(pair_e.gamma_s0-pair_e.g0[2])], [pair_e.s0[0], pair_e.s0[0]+pair_e.sdd*np.sin(pair_e.gamma_s0-pair_e.g0[2])], '--', color='indigo')
    plt.plot([pair_e.s0[2], pair_e.s0[2]-pair_e.sdd*np.cos(pair_e.gamma_e0[0]-pair_e.g0[2])], [pair_e.s0[0], pair_e.s0[0]+pair_e.sdd*np.sin(pair_e.gamma_e0[0]-pair_e.g0[2])], '-.', color='indigo')
    plt.plot(pair_e.s1[2], pair_e.s1[0], '.', color='darkorange')
    plt.plot(pair_e.Det1[:, 0, 2], pair_e.Det1[:, 0, 0], color='darkorange')
    plt.plot([pair_e.s1[2], pair_e.s1[2]-pair_e.sdd*np.cos(pair_e.gamma_s1-pair_e.g1[2])], [pair_e.s1[0], pair_e.s1[0]+pair_e.sdd*np.sin(pair_e.gamma_s1-pair_e.g1[2])], '--', color='darkorange')
    plt.plot([pair_e.s1[2], pair_e.s1[2]-pair_e.sdd*np.cos(pair_e.gamma_e1[0]-pair_e.g1[2])], [pair_e.s1[0], pair_e.s1[0]+pair_e.sdd*np.sin(pair_e.gamma_e1[0]-pair_e.g1[2])], '-.', color='darkorange')
    plt.plot(pair_e.m_points[2][len(pair_e.m_points[1])//2], pair_e.m_points[0][len(pair_e.m_points[1])//2], 'r+')
    plt.plot([pair_e.s0[2], pair_e.s0[2] + 100*pair_e.eb0[2]], [pair_e.s0[0], pair_e.s0[0]+100*pair_e.eb0[0]], color='lightblue')
    plt.plot([pair_e.s1[2], pair_e.s1[2] + 100*pair_e.eb1[2]], [pair_e.s1[0], pair_e.s1[0]+100*pair_e.eb1[0]], color='lightblue')
    for i in range(pair_e.ee0.shape[0]):
        plt.plot([pair_e.s0[2], pair_e.s0[2] + 100*pair_e.ee0[i, 2]], [pair_e.s0[0], pair_e.s0[0] + 100*pair_e.ee0[i, 0]], color='blue')
        plt.plot([pair_e.s1[2], pair_e.s1[2] + 100*pair_e.ee1[i, 2]], [pair_e.s1[0], pair_e.s1[0] + 100*pair_e.ee1[i, 0]], color='blue')
    plt.xlabel("z_rtk")
    plt.ylabel("x_rtk")
    plt.axis("equal")
    plt.subplot(122)
    for i in range(pair_e.en.shape[0]):
        plt.plot([0, 100*pair_e.en[i, 2]], [(pair_e.s0[1]+pair_e.s1[1])*0.5, (pair_e.s0[1]+pair_e.s1[1])*0.5+ 5*pair_e.en[i, 1]], color='darkblue')
    ...
    plt.plot([pair_e.s0[2], pair_e.s0[2] + 100*pair_e.eb0[2]], [pair_e.s0[1], pair_e.s0[1]+pair_e.eb0[1]], color='lightblue')
    plt.plot([pair_e.s1[2], pair_e.s1[2] + 100*pair_e.eb1[2]], [pair_e.s1[1], pair_e.s1[1]+pair_e.eb1[1]], color='lightblue')
    # plt.plot(pair_e.m_points[2, :], pair_e.m_points[1, :], color='red')
    plt.xlabel("z_rtk")
    plt.ylabel("y_rtk")
    # plt.axis("equal")
    plt.show()
    ...
    plt.figure()
    plt.imshow(pair_e.p0, cmap = "gray",extent=(1113.*pair_e.gamma0[0], 1113.*pair_e.gamma0[-1], pair_e.v_det0[-1], pair_e.v_det0[0]), aspect="auto", interpolation='nearest')
    plt.plot(1113.*pair_e.gamma0, pair_e.v_det0[0]*np.ones(len(pair_e.gamma0)), color='indigo')
    plt.plot(1113.*pair_e.gamma0, pair_e.v_det0[-1]*np.ones(len(pair_e.gamma0)), color='indigo')
    plt.plot(1113.*pair_e.gamma0[0]*np.ones(len(pair_e.v_det0)), pair_e.v_det0, color='indigo')
    plt.plot(1113.*pair_e.gamma0[-1]*np.ones(len(pair_e.v_det0)), pair_e.v_det0, color='indigo')
    for j in range(pair_e.v0.shape[1]):
        plt.plot(1113.*pair_e.gamma0, pair_e.v0[:,j], linewidth=0.5)
    plt.xlabel(r"$D\gamma$ (mm)")
    plt.ylabel(r"$v$ (mm)")
    plt.show()

    plt.figure()
    plt.imshow(pair_e.p1, cmap = "gray",extent=(1113.*pair_e.gamma1[0], 1113.*pair_e.gamma1[-1], pair_e.v_det1[-1], pair_e.v_det1[0]), aspect="auto", interpolation='nearest')
    plt.plot(1113.*pair_e.gamma1, pair_e.v_det1[0]*np.ones(len(pair_e.gamma1)), color='darkorange')
    plt.plot(1113.*pair_e.gamma1, pair_e.v_det1[-1]*np.ones(len(pair_e.gamma1)), color='darkorange')
    plt.plot(1113.*pair_e.gamma1[0]*np.ones(len(pair_e.v_det1)), pair_e.v_det1, color='darkorange')
    plt.plot(1113.*pair_e.gamma1[-1]*np.ones(len(pair_e.v_det1)), pair_e.v_det1, color='darkorange')
    for j in range(pair_e.v1.shape[1]):
        plt.plot(1113.*pair_e.gamma1, pair_e.v1[:,j], linewidth=0.5)
    plt.xlabel(r"$D\gamma$ (mm)")
    plt.ylabel(r"$v$ (mm)")
    plt.show()


def PlotPairGeometry2Bis(pair_e):
    plt.figure()
    plt.subplot(121)
    # plt.plot(250*np.cos(np.linspace(0,2*np.pi)), 250*np.sin(np.linspace(0,2*np.pi)), 'k--', linewidth=0.5)
    #epipolar drawings
    ...
    plt.plot([pair_e.s1[2], pair_e.s1[2] + 100*pair_e.eb[2]], [pair_e.s1[0], pair_e.s1[0]+100*pair_e.eb[0]], color='lightblue')
    for i in range(pair_e.ee.shape[1]):
        plt.plot([pair_e.s0[2], pair_e.s0[2] + 100*pair_e.ee[2, i]], [pair_e.s0[0], pair_e.s0[0] + 100*pair_e.ee[0, i]], color='blue')
        plt.plot([pair_e.s1[2], pair_e.s1[2] + 100*pair_e.ee[2, i]], [pair_e.s1[0], pair_e.s1[0] + 100*pair_e.ee[0, i]], color='blue')
    plt.xlabel("z_rtk")
    plt.ylabel("x_rtk")
    plt.axis("equal")
    plt.subplot(122)
    for i in range(pair_e.en.shape[1]):
        plt.plot([0, 100*pair_e.en[2, i]], [(pair_e.s0[1]+pair_e.s1[1])*0.5, (pair_e.s0[1]+pair_e.s1[1])*0.5+ 5*pair_e.en[1, i]], color='darkblue')
    plt.plot(pair_e.s0[2], pair_e.s0[1], '.', color='indigo')
    plt.plot(pair_e.Det0[pair_e.Det0.shape[0]//2, :, 2], pair_e.Det0[pair_e.Det0.shape[0]//2, :, 1], color='indigo')
    plt.plot(pair_e.s1[2], pair_e.s1[1], '.', color='darkorange')
    plt.plot(pair_e.Det1[pair_e.Det0.shape[0]//2, :, 2], pair_e.Det1[pair_e.Det0.shape[0]//2, :, 1], color='darkorange')
    plt.plot([pair_e.s0[2], pair_e.s0[2] + 100*pair_e.eb[2]], [pair_e.s0[1], pair_e.s0[1]+pair_e.eb[1]], color='lightblue')
    plt.plot([pair_e.s1[2], pair_e.s1[2] + 100*pair_e.eb[2]], [pair_e.s1[1], pair_e.s1[1]+pair_e.eb[1]], color='lightblue')
    # plt.plot(pair_e.m_points[2, :], pair_e.m_points[1, :], color='red')
    plt.xlabel("z_rtk")
    plt.ylabel("y_rtk")
    # plt.axis("equal")
...
#     plt.show()
    ...
    plt.plot([pair_e.s1[2], pair_e.s1[2]+ 100*pair_e.eb[2]], [pair_e.s1[0], pair_e.s1[0]+100*pair_e.eb[0]],color='lightblue')
    plt.plot([pair_e.s1[2], pair_e.s1[2]+pair_e.en[0][2]], [pair_e.s1[0], pair_e.s1[0]+ pair_e.en[0][0]],color='darkblue')
    plt.plot([pair_e.s1[2], pair_e.s1[2]+100*ee[2]], [pair_e.s1[0], pair_e.s1[0] +100*ee[0]],color='blue')
...
#     plt.plot([pair_bp.CornersDet1[0][2], pair_bp.CornersDet1[1][2]],[pair_bp.CornersDet1[0][0], pair_bp.CornersDet1[1][0]], color="darkorange", linestyle="--")
    ...
    plt.plot([pair_e.s0[2], pair_e.s0[2]+100*pair_e.en[0][2]], [pair_e.s0[1], pair_e.s0[1]+ 5*pair_e.en[0][1]], color='darkblue')
...
#     plt.axis("equal")
    plt.subplot(223)
    plt.title("Projection acquired at $\lambda=$%.1f°" %(pair_e.g0[2]*180/np.pi))
    plt.imshow(pair_e.p0, cmap = "gray", origin = "lower",extent=(1113.*pair_e.gamma0[0], 1113.*pair_e.gamma0[-1], pair_e.v_det0[0], pair_e.v_det0[-1]), aspect="auto")
    plt.plot(1113.*pair_e.gamma0, pair_e.v_det0[0]*np.ones(len(pair_e.gamma0)), color='indigo')
    plt.plot(1113.*pair_e.gamma0, pair_e.v_det0[-1]*np.ones(len(pair_e.gamma0)), color='indigo')
    plt.plot(1113.*pair_e.gamma0[0]*np.ones(len(pair_e.v_det0)), pair_e.v_det0, color='indigo')
    plt.plot(1113.*pair_e.gamma0[-1]*np.ones(len(pair_e.v_det0)), pair_e.v_det0, color='indigo')
    ...
    plt.ylabel(r"$v$ (mm)")
    plt.subplot(224)
    plt.title("Projection acquired at $\lambda'=$%.1f°" %(pair_e.g1[2]*180/np.pi))
    plt.imshow(pair_e.p1, cmap = "gray", origin = "lower", extent=(1113.*pair_e.gamma1[0], 1113.*pair_e.gamma1[-1], pair_e.v_det1[0], pair_e.v_det1[-1]), aspect="auto")
    plt.plot(1113.*pair_e.gamma1, pair_e.v_det1[0]*np.ones(len(pair_e.gamma1)), color='darkorange')
    plt.plot(1113.*pair_e.gamma1, pair_e.v_det1[-1]*np.ones(len(pair_e.gamma1)), color='darkorange')
    plt.plot(1113.*pair_e.gamma1[0]*np.ones(len(pair_e.v_det1)), pair_e.v_det1, color='darkorange')
    plt.plot(1113.*pair_e.gamma1[-1]*np.ones(len(pair_e.v_det1)), pair_e.v_det1, color='darkorange')
