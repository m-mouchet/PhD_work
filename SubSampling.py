...
workdir = "/home/mmouchet/Documents/SIEMENSDATA/GO.SIM/phantom/14_12_21/4D/donneesBrutes/P007_Trot035_Tresp4/"

proj = itk.imread(workdir+"proj_n375_n290.mha")
proj_array = itk.GetArrayFromImage(proj)
geometry = ReadGeometry(workdir+"geometry_n375_n290.xml")
out_proj_file = workdir+"sub288_proj_n375_n290.mha"
out_geometry_file = workdir+"sub288_geometry_n375_n290.xml"
...
idx_selection_one_rotation = np.arange(0, n_proj_per_rotation, 4)
